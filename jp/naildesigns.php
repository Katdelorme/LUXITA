  ...
  <div id="fullpage">
	<div class="container-fluid">
		...
		<section class="section" id="fashion">
          ...
          <p>En vogue patterns and colors lined up on your nails.</p>
					<p>ワンカラーの単色で塗られたマニキュアの時代は終わりを迎えている。ネイルは身体の一部となり、アクセサリーにおいて最も近しい存在とも言える。身体の一部となった爪上のアクセサリーは日常のファッションにおいてイアリングやハンドバックのように欠かせない存在となるでしょう。</p>
				</div>
			</div>
		</section>
    ...
    <section  class="section" id="ita">
      <div class="row">
          ...
          <p>痛ネイルとは爪上をキャンバスとして「模写」という特殊な技術を駆使して手描きで描きあげる高等技術のことです。デザインは多岐にわたり、漫画やアニメのキャラクター、映画の世界観からペットにまでわたり、爪上に直接手描きで描きあげるため、アートの世界を無限の可能性へと誘います。この技術は習得にかなりの時間を費やし、鍛錬してきた人のみに可能な技であるため、その繊細さと緻密さに貴女は驚くことでしょう。</p>
				</div>
    ...
    <section class="section" id="diamond">
          ...
          <p>Diamond nails applied directly to the nail bed.</p>
					<p>至高のダイヤモンドを貴女の爪上に。このネイルは世界中で最も高価なネイルであり、女性にとって一番の親友とも言われるダイヤモンドを毎日貴女の爪上に着飾ることで日々の生活に輝きを届ける。ネイルで使用するダイヤモンドは繰り返し次の施術でも使用可能です。今までにない輝きを貴女の日々に。</p>
				</div>
			</div>
		</section>
